...
***/
  ...
  Future<RefreshAnswer> _getNewAccessToken(
    ...
    final resp = await http.post(Uri.tryParse(urlRefresh));
  ...
  Future<Token> _getStravaToken(
    ...
    final value = await http.post(Uri.tryParse(urlToken));
  ...
  Future<Fault> deAuthorize() async {
    ...
    if (_header.containsKey('88') == false) {
      ...
      final rep =
          await http.post(Uri.tryParse(reqDeAuthorize), headers: _header);
