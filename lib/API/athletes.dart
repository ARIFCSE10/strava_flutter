...
abstract class Athletes {
  Future<DetailedAthlete> updateLoggedInAthlete(double weight) async {
    ...
    if (_header.containsKey('88') == false) {
      ...
      var rep = await http.put(Uri.tryParse(reqAthlete), headers: _header);
  ...
  Future<Stats> getStats(int id) async {
    ...
    if (_header.containsKey('88') == false) {
      ...
      var rep = await http.get(Uri.tryParse(reqStats), headers: _header);
  ...
  Future<Zone> getLoggedInAthleteZones() async {
    ...
    if (_header.containsKey('88') == false) {
      ...
      var rep = await http.get(Uri.tryParse(reqAthlete), headers: _header);
  ...
  Future<List<SummaryActivity>> getLoggedInAthleteActivities(
    ...
    if (_header.containsKey('88') == false) {
      do {
        ...
        var rep = await http.get(Uri.tryParse(reqActivities), headers: _header);
        int _nbActvity = 0;
